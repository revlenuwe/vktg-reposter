...
use App\Http\Controllers\Commands\AddChannelCommand;
use App\Http\Controllers\Commands\AddGroupCommand;
use App\Http\Controllers\Commands\BindChannelToGroupCommand;
use App\Http\Controllers\Commands\StartCommand;
use Telegram\Bot\Commands\HelpCommand;

return [
    'admin_chat_id' => env('TELEGRAM_BOT_ADMIN_ID'),
    ...
    'bots'                         => [
        'mybot' => [
            ...
            'commands'            => [
                ...
                BindChannelToGroupCommand::class
            ],
        ],
